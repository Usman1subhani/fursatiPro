...
export default function Testimonials() {
  ...
  // Auto-slide every 5 seconds (keeps previous behavior)
  useEffect(() => {
  ...
  // get items for the current slide (keeps your sliding logic)
  ...
  return (
    <Box
      ...
      sx={{
        py: { xs: 6, md: 10 },
        background:
          "linear-gradient(to bottom right, #E6FAFC 20%, #FFFFFF 80%)",
      }}
    >
      <Container maxWidth="lg">
        ...
        <Box
          sx={{
            ...
            justifyContent: { xs: "flex-start" ,sm: "center", md: "center" }, // ✅ Center on large
          }}
        >
          {visibleTestimonials.map((t, index) => (
            <Card
              ...
              sx={{
                ...
                width: { xs: "85%", sm: "60%", md: "350px", lg: "360px" },
                flex: "0 0 auto",
            ...
            >
              <FormatQuoteIcon sx={{ color: "#25DCE0", fontSize: 32 }} />
              <Typography
                sx={{
                  color: "#555",
                  fontSize: "0.95rem",
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                ...
                <Box>
                  <Typography
                    sx={{ fontSize: "0.95rem", fontWeight: 600, color: "#000" }}
                  >
                    {t.name}
                  </Typography>
                  <Rating
